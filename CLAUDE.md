...
- **Chrome Extension V2**: Manifest V2 structure with new tab override functionality
...
Located in `manifest.json` - Chrome extension configuration including permissions, shortcuts, and content security policy.
...
4. Update manifest permissions if required
